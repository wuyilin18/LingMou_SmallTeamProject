...
Toggle between them with the physical button on GPIO 9.
...
<p align="center">
  ...
  &nbsp;
  <img src="docs/images/app-eye-night.jpg" width="24%" alt="App — Eye mode (dark)">
  &nbsp;
  <img src="docs/images/wifi-setup.jpg" width="24%" alt="App — WiFi provisioning">
</p>
<p align="center"><i>LingMou Control app: 18-emotion picker + eye control (left/center) and WiFi provisioning (right).</i></p>
